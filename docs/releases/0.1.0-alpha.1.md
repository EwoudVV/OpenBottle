...
- [full CI](https://github.com/EwoudVV/OpenBottle/actions/runs/34058601041):
  formatting, strict lint, localization/identity, all three Xcode schemes, 1,640
  package tests, and the UI tests;
- [preview build](https://github.com/EwoudVV/OpenBottle/actions/runs/34058607183):
  Release compile, deep ad-hoc signature verification, DMG/ZIP packaging, and
  artifact upload;
- local fresh install: runtime download and manifest, automatic `Games`
  bottle, library landing screen, persistent Install button, and Stable runtime
  menu all passed;
- `OpenBottle-0.1.0-alpha.1.dmg` SHA-256:
  `7034311f3c46f579574f1a887da852b2bf138d9cb5286b518a86c22f946f20cc`;
- `OpenBottle-0.1.0-alpha.1.zip` SHA-256:
