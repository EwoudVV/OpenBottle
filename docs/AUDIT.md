...
| [#1264](https://github.com/whisky-app/whisky/pull/1264) | Make `OpenBottleCmd run` actually launch the program (#1088, #1140) | **Fixed** — the CLI was rearchitected onto awaited `Wine.runProgram`, so the AppleScript-exits-early race and the env-var quote-escaping bug can't occur |
